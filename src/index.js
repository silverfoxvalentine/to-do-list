import './style.css'
import { categoriesSection, displayCategory, nonProjectTasksFunction, allTasksFunction, todayTasksFuncion, thisWeekTasksFunction } from './category'
...
export const changeStorage = function() {
    ...
    for (let project of projectInStorage) {
...
for (const todo of projects[0].todos) {
